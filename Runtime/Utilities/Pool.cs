...
namespace RoyTheunissen.FMODSyntax.Utilities
{
    /// <summary>
        ...
        where ObjectType : class
    {
        ...
        private readonly List<ObjectType> allObjects = new();
        public List<ObjectType> AllObjects => allObjects;

        private readonly List<ObjectType> availableObjects = new();
        public List<ObjectType> AvailableObjects => availableObjects;

        private readonly List<ObjectType> usedObjects = new();
        ...
        private readonly ObjectDestroyer objectDestroyer;
        ...
        private readonly ObjectDeactivator objectDeactivator;
